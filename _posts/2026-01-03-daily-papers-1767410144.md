...
1. **Improving Multi-step RAG with Hypergraph-based Memory for Long-Context Complex Relational Modeling** - 👍 47
   - 기관: Tencent93
...
2. **Dynamic Large Concept Models: Latent Reasoning in an Adaptive Semantic Space** - 👍 26
   - 기관: ByteDance Seed3
...
3. **DiffThinker: Towards Generative Multimodal Reasoning with Diffusion Models** - 👍 17
   - 기관: ·6 authors164
...
5. **FlowBlending: Stage-Aware Multi-Model Sampling for Fast and High-Fidelity Video Generation** - 👍 2
   - 기관: ·4 authors3
...
6. **Dream2Flow: Bridging Video Generation and Open-World Manipulation with 3D Object Flow** - 👍 1
   - 기관: ·5 authors3
