...
1. **Improving Multi-step RAG with Hypergraph-based Memory for Long-Context Complex Relational Modeling** - 👍 80
   - 기관: Tencent263
...
2. **Dynamic Large Concept Models: Latent Reasoning in an Adaptive Semantic Space** - 👍 40
   - 기관: ByteDance Seed4
...
3. **DiffThinker: Towards Generative Multimodal Reasoning with Diffusion Models** - 👍 37
   - 기관: ·6 authors384
...
4. **On the Role of Discreteness in Diffusion LLMs** - 👍 14
   - 기관: MiroMind AI4
...
7. **TESO Tabu Enhanced Simulation Optimization for Noisy Black Box Problems** - 👍 2
   - 기관: ·3 authors42
