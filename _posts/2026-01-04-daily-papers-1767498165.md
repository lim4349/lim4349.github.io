---
title: Hugging Face Daily Papers - 2026-01-04
date: 2026-01-04 09:15:00 +0900
categories: [Daily Papers, 일간]
tags: [huggingface, papers, daily, ai]
author: lim4349
---

# Hugging Face Daily Papers - 2026-01-04

총 **7개**의 논문이 수집되었습니다.

## 📊 좋아요 순위

1. **Improving Multi-step RAG with Hypergraph-based Memory for Long-Context Complex Relational Modeling** - 👍 75
   - 기관: Tencent223
...
2. **Dynamic Large Concept Models: Latent Reasoning in an Adaptive Semantic Space** - 👍 34
   - 기관: ByteDance Seed4
...
3. **DiffThinker: Towards Generative Multimodal Reasoning with Diffusion Models** - 👍 28
   - 기관: ·6 authors244
...
4. **On the Role of Discreteness in Diffusion LLMs** - 👍 10
   - 기관: MiroMind AI3
...
5. **Dream2Flow: Bridging Video Generation and Open-World Manipulation with 3D Object Flow** - 👍 6
   - 기관: ·5 authors3
   - [HF 페이지](https://huggingface.co/papers/2512.24766)
   - [논문 링크](https://arxiv.org/abs/2512.24766)
...
6. **FlowBlending: Stage-Aware Multi-Model Sampling for Fast and High-Fidelity Video Generation** - 👍 4
   - 기관: ·4 authors3
   - [HF 페이지](https://huggingface.co/papers/2512.24724)
   - [논문 링크](https://arxiv.org/abs/2512.24724)
...
7. **TESO Tabu Enhanced Simulation Optimization for Noisy Black Box Problems** - 👍 1
   - 기관: ·3 authors42
   - [HF 페이지](https://huggingface.co/papers/2512.24007)
   - [논문 링크](https://arxiv.org/abs/2512.24007)
