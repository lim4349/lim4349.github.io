...
1. **Scaling Mixture-of-Experts Video Pretraining for Embodied Intelligence** - 👍 26
   - 기관: ·27 authors77
...
2. **Dual Latent Memory in Vision-Language-Action Models for Robotic Manipulation** - 👍 12
   - 기관: ·9 authors01
...
3. **Infinite Worlds with Versatile Interactions** - 👍 12
   - 기관: ·20 authors50
...
4. **RoboDojo: A Unified Sim-and-Real Benchmark for Comprehensive Evaluation of Generalist Robot Manipulation Policies** - 👍 4
   - 기관: RoboDojo-Benchmark921
...
5. **WildCity: A Real-World City-Scale Testbed for Rendering, Simulation, and Spatial Intelligence** - 👍 2
   - 기관: NVIDIA2
