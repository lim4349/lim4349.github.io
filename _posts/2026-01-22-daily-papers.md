...
1. **Agentic Reasoning for Large Language Models** - 👍 44
   - 기관: University of Illinois at Urbana-Champaign121
...
2. **Render-of-Thought: Rendering Textual Chain-of-Thought as Images for Visual Latent Reasoning** - 👍 1
   - 기관: Tencent
...
3. **Lost in the Prompt Order: Revealing the Limitations of Causal Attention in Language Models** - 👍 1
   - 기관: Pohang University of Science and Technology1
   - [HF 페이지](https://huggingface.co/papers/2601.14152)
   - [논문 링크](https://arxiv.org/abs/2601.14152)
...
4. **Facilitating Proactive and Reactive Guidance for Decision Making on the Web: A Design Probe with WebSeek** - 👍 0
   - 기관: ·2 authors
   - [HF 페이지](https://huggingface.co/papers/2601.15100)
   - [논문 링크](https://arxiv.org/abs/2601.15100)
...
5. **FARE: Fast-Slow Agentic Robotic Exploration** - 👍 0
   - 기관: ·9 authors
   - [HF 페이지](https://huggingface.co/papers/2601.14681)
   - [논문 링크](https://arxiv.org/abs/2601.14681)
...
6. **RoboBrain 2.5: Depth in Sight, Time in Mind** - 👍 0
   - 기관: ·35 authors
   - [HF 페이지](https://huggingface.co/papers/2601.14352)
   - [논문 링크](https://arxiv.org/abs/2601.14352)
