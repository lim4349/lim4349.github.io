---
title: Hugging Face Daily Papers - 2026-01-03
date: 2026-01-03 09:15:00 +0900
categories: [Daily Papers, 일간]
tags: [huggingface, papers, daily, ai]
author: lim4349
---

# Hugging Face Daily Papers - 2026-01-03

총 **7개**의 논문이 수집되었습니다.

## 📊 좋아요 순위

1. **Improving Multi-step RAG with Hypergraph-based Memory for Long-Context Complex Relational Modeling** - 👍 65
   - 기관: Tencent173
...
2. **Dynamic Large Concept Models: Latent Reasoning in an Adaptive Semantic Space** - 👍 31
   - 기관: ByteDance Seed4
...
3. **DiffThinker: Towards Generative Multimodal Reasoning with Diffusion Models** - 👍 20
   - 기관: ·6 authors214
...
4. **On the Role of Discreteness in Diffusion LLMs** - 👍 9
   - 기관: MiroMind AI3
...
5. **Dream2Flow: Bridging Video Generation and Open-World Manipulation with 3D Object Flow** - 👍 3
   - 기관: ·5 authors3
...
6. **FlowBlending: Stage-Aware Multi-Model Sampling for Fast and High-Fidelity Video Generation** - 👍 2
   - 기관: ·4 authors3
