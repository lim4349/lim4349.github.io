...
1. **Latent Implicit Visual Reasoning** - 👍 35
   - 기관: UC Berkeley2
...
2. **Emergent temporal abstractions in autoregressive models enable hierarchical reinforcement learning** - 👍 26
   - 기관: Google2
...
3. **Spatia: Video Generation with Updatable Spatial Memory** - 👍 15
   - 기관: The University of Sydney562
...
4. **Schoenfeld's Anatomy of Mathematical Reasoning by Language Models** - 👍 5
   - 기관: ·5 authors63
...
5. **How Much 3D Do Video Foundation Models Encode?** - 👍 4
...
6. **VA-π: Variational Policy Alignment for Pixel-Aware Autoregressive Generation** - 👍 3
   - 기관: ·7 authors42
