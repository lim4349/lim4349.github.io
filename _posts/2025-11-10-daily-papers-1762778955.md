...
1. **DeepEyesV2: Toward Agentic Multimodal Model** - 👍 23
   - 기관: ·6 authors
...
2. **Too Good to be Bad: On the Failure of LLMs to Role-Play Villains** - 👍 19
   - 기관: Tencent
...
4. **Towards Mitigating Hallucinations in Large Vision-Language Models by
  Refining Textual Embeddings** - 👍 4
   - 기관: ·8 authors
...
5. **Jailbreaking in the Haystack** - 👍 1
   - 기관: ·6 authors
...
6. **CritiCal: Can Critique Help LLM Uncertainty or Confidence Calibration?** - 👍 1
   - 기관: ·10 authors
   - [HF 페이지](https://huggingface.co/papers/2510.24505)
   - [논문 링크](https://arxiv.org/abs/2510.24505)
