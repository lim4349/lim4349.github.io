...
1. **Latent Implicit Visual Reasoning** - 👍 29
   - 기관: UC Berkeley1
...
2. **Spatia: Video Generation with Updatable Spatial Memory** - 👍 12
   - 기관: The University of Sydney371
...
3. **Schoenfeld's Anatomy of Mathematical Reasoning by Language Models** - 👍 4
   - 기관: ·5 authors12
...
4. **How Much 3D Do Video Foundation Models Encode?** - 👍 4
...
5. **VA-π: Variational Policy Alignment for Pixel-Aware Autoregressive Generation** - 👍 3
   - 기관: ·7 authors41
...
6. **GTR-Turbo: Merged Checkpoint is Secretly a Free Teacher for Agentic VLM Training** - 👍 3
   - 기관: ·7 authors1
...
7. **Emergent temporal abstractions in autoregressive models enable hierarchical reinforcement learning** - 👍 0
   - 기관: Google1
