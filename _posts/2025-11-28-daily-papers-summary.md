...
1. **Video Generation Models Are Good Latent Reward Models** - 👍 15
   - 기관: Tencent Hunyuan
   - [HF 페이지](https://huggingface.co/papers/2511.21541)
   - [논문 링크](https://arxiv.org/abs/2511.21541)
...
2. **Canvas-to-Image: Compositional Image Generation with Multimodal Controls** - 👍 11
   - 기관: ·8 authors
   - [HF 페이지](https://huggingface.co/papers/2511.21691)
   - [논문 링크](https://arxiv.org/abs/2511.21691)
...
3. **MIRA: Multimodal Iterative Reasoning Agent for Image Editing** - 👍 5
   - 기관: ·3 authors
...
4. **Multi-Crit: Benchmarking Multimodal Judges on Pluralistic Criteria-Following** - 👍 2
...
5. **What does it mean to understand language?** - 👍 1
   - 기관: Massachusetts Institute of Technology
   - [HF 페이지](https://huggingface.co/papers/2511.19757)
   - [논문 링크](https://arxiv.org/abs/2511.19757)
...
6. **Agentic Learner with Grow-and-Refine Multimodal Semantic Memory** - 👍 0
   - 기관: ·12 authors
   - [HF 페이지](https://huggingface.co/papers/2511.21678)
   - [논문 링크](https://arxiv.org/abs/2511.21678)
