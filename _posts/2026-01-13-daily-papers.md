...
1. **What Users Leave Unsaid: Under-Specified Queries Limit Vision-Language Models** - 👍 2
   - 기관: HAE-RAE101
   - [HF 페이지](https://huggingface.co/papers/2601.06165)
   - [논문 링크](https://arxiv.org/abs/2601.06165)
...
2. **ET-Agent: Incentivizing Effective Tool-Integrated Reasoning Agent via Behavior Calibration** - 👍 1
   - 기관: Renmin University of China1
   - [HF 페이지](https://huggingface.co/papers/2601.06860)
   - [논문 링크](https://arxiv.org/abs/2601.06860)
...
3. **TourPlanner: A Competitive Consensus Framework with Constraint-Gated Reinforcement Learning for Travel Planning** - 👍 1
   - 기관: ·8 authors1
   - [HF 페이지](https://huggingface.co/papers/2601.04698)
   - [논문 링크](https://arxiv.org/abs/2601.04698)
